...
const CoordinatorLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { text: 'View Students', icon: <People />, path: '/coordinator/students' },
    { text: 'View Drives', icon: <Work />, path: '/coordinator/drives' },
    { text: 'Resources', icon: <Folder />, path: '/coordinator/resources' },
  ];
    ...
    >
      ...
      >
        <Typography
          ...
          noWrap
          component="div"
          sx={{ fontWeight: 800, fontSize: '1.05rem', letterSpacing: 0.6, color: '#ffffff' }}
        >
          Coordinator Portal
        </Typography>
      </Toolbar>
    ...
    >
      ...
      >
        <Toolbar>
          ...
          >
            <MenuItem onClick={() => { navigate('/coordinator/settings'); handleMenuClose(); }}>
              <ListItemIcon>
